...
import com.android.halanvendordiscovery.data.details.mapper.MerchantRemoteMapper
...
class DetailsRepositoryImpl @Inject constructor(private val service: DetailsService):
    ...
    override suspend fun getMerchants(vendorId: String) =
        withContext(Dispatchers.IO) {
                ...
                merchantsResponse.data?.merchants?.map { dto -> MerchantRemoteMapper.toDomain(dto) }.orEmpty()
        }
}